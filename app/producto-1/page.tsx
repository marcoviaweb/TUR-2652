...
export default function ProductOnePage() {
  ...
  return (
    <main className="lunar-page min-h-screen overflow-x-hidden bg-[#f1e8dc] text-[#302521]">
      ...
      <section className="lunar-people" aria-label="Momentos de la experiencia turística">
        <div className="section-shell py-24 lg:py-36">
          ...
          <div className="lunar-people-grid">
            <motion.figure {...reveal} className="lunar-people-card lunar-people-card-main"><Image src="/concepto-teleferico.webp" alt="Viajeros disfrutando la vista de La Paz y una experiencia sonora dentro del teleférico" fill sizes="(min-width: 900px) 60vw, 100vw" className="object-cover" /><figcaption><span>01 · Elevarse</span><strong>Escucha las historias que sobrevuelan la ciudad.</strong></figcaption></motion.figure>
            <motion.figure {...reveal} className="lunar-people-card"><Image src="/concepto-exploracion.webp" alt="Turistas exploran las formaciones del Valle de la Luna junto a un guía local" fill sizes="(min-width: 900px) 40vw, 100vw" className="object-cover" /><figcaption><span>02 · Explorar</span><strong>Descubre un paisaje que parece de otro mundo.</strong></figcaption></motion.figure>
            <motion.figure {...reveal} className="lunar-people-card"><Image src="/concepto-cultura.webp" alt="Visitantes comparten bebidas y sabores bolivianos con anfitriones locales" fill sizes="(min-width: 900px) 40vw, 100vw" className="object-cover" /><figcaption><span>03 · Compartir</span><strong>Saborea la hospitalidad y la cultura de La Paz.</strong></figcaption></motion.figure>
          </div>
      ...
      <section className="lunar-senses"><div className="lunar-senses-image" aria-hidden="true"><Image src="/concepto-cultura.webp" alt="" fill sizes="100vw" className="object-cover object-center" /></div><div className="section-shell relative z-10 py-24 lg:py-36">
