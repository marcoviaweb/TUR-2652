...
export default function ProductOnePage() {
  ...
  return (
    <main className="lunar-page min-h-screen overflow-x-hidden bg-[#f1e8dc] text-[#302521]">
      ...
      <section className="lunar-senses"><div className="lunar-senses-image" aria-hidden="true"><Image src="/valle-luna-hero.png" alt="" fill sizes="100vw" className="object-cover object-[75%_65%]" /></div><div className="section-shell relative z-10 py-24 lg:py-36">
