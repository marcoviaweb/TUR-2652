  ...
  return (
    <header className={`product-header ${compact ? "product-header-compact" : ""}`}>
      <div className="section-shell flex items-center justify-between gap-4 py-4">
        <a href="/" className="product-brand" aria-label="Volver a la página principal">
        ...
        <a href="/" className="back-link"><ArrowLeft aria-hidden="true" /> <span>Volver al inicio</span></a>
      </div>
    </header>
  );
}
